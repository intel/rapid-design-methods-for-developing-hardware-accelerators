...
dut.add_ut( UserType("BlkInp",[ArrayField(UnsignedCharField("data"),32)]))

dut.add_ut( UserType("BlkOut",[ArrayField(SignedCharField("data"),32)]))

dut.add_ut( UserType("BlkMid",[ArrayField(SignedShortField("data"),32)]))
