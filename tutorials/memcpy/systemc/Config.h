...
#include "CacheLine.h"
//[[[end]]] (checksum: 2089e73fdf2a217c510ef12aa3a45e9f)
...
private:
  ...
  //[[[end]]] (checksum: e7eb0c6c9c7fde0db4ebf60ca78637a6)  
...
public:
  ...
  //[[[end]]] (checksum: 123ab78e7c213e52b759a33ddf043ad5)  
  ...
  //[[[end]]] (checksum: 02ade3ecd0ada523a9c5bb283a9a2737)  
  ...
  //[[[end]]] (checksum: 541633fa6bca95977cb0249172ff5cd3)  
  ...
  //[[[end]]] (checksum: 576aca9a581edb74475f227631a6ddcb)  
  ...
  //[[[end]]] (checksum: 4cf6418a74de333a08aeaaa40aa841fa)  
  ...
  Config() {
    ...
    nCLs = 0;
    //[[[end]]] (checksum: c39e7bae4fbd246f05596441ede77cbe)  
  }
  void copy(Config &from) {
    ...
    nCLs = from.nCLs;
    //[[[end]]] (checksum: 4ec68336e6313ed696890f18e81f974b)  
  }
  ...
  inline friend std::ostream& operator<<(std::ostream& os, const Config& d) {
    ...
    //[[[end]]] (checksum: 35289570e7ba6581f53b61001bfc6a1b)  
    return os;
  }
  ...
  inline bool operator==(const Config& rhs) const {
    ...
    //[[[end]]] (checksum: 0a0707c483abe7adaa7d2ca9fa20ccf5)  
    return result;
  }
};
